...
public class ApkSignerTool {
    ...
    private static void sign(String[] params) throws ParameterException, OptionsParser.OptionsException, IOException,
            SignatureException, IllegalStateException, ApkFormatException, InvalidKeySpecException, InvalidKeyException, NoSuchAlgorithmException {
        if (params.length == 0) {
    ...
    public static boolean verify(String[] params) throws ParameterException, OptionsParser.OptionsException, IOException,
            SignatureException, IllegalStateException, NoSuchAlgorithmException, ApkFormatException, CertificateEncodingException {
        if (params.length == 0) {
        ...
        return verified || !warningsTreatedAsErrors || !warningsEncountered;
    }
